 ...
 <div class="container d-flex justify-content-center mt-3">
     <div class="w-75">
         ...
         <div class="row">
             ...
             <div class="col-md-2 mt-2">
                 <a href="{{route('products.show', $product->id)}}">
                     ...
                     <img src="{{ asset($product->option->image)}}" class="img-fluid w-100">
                     @else
         ...
         <form method="post" action="{{route('carts.destroy')}}" class="d-flex justify-content-end mt-3">
            ...
            <a href="{{route('products.index')}}" class="btn samuraimart-favorite-button border text-dark mr-3">
                買い物を続ける
            </a>
            @if ($total > 0)
            <div class="btn samuraimart-submit-button" data-bs-toggle="modal" data-bs-target="#buy-confirm-modal">購入を確定する</div>
            @else
            <div class="btn samuraimart-submit-button disabled" data-bs-toggle="model" data-bs-target="#buy-confirm-modal">購入を確定する</div>
            @endif
